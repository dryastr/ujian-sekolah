                    ...
                    <div class="card-body d-flex justify-content-between align-items-center"
                        ...
                        <div class="d-flex align-items-center">
                            <a href="#" class="burger-btn d-block d-xl-none">
                                <i class="bi fs-3"></i>
                                <h5 class="card-title d-none m-0"></h5>
                            </a>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="dropdown">
                                @if (Auth::check())
                                    ...
                                    <img src="{{ Auth::user()->img_profile ? asset('storage/' . Auth::user()->img_profile) : 'https://www.pngall.com/wp-content/uploads/5/User-Profile-PNG-Image.png' }}"
                                        alt="Profile" class="profile-img" id="profileDropdown"
                                        data-bs-toggle="dropdown" aria-expanded="false" width="50"
                                        style="
                                        width: 40px;
                                        height: 40px;
                                        border-radius: 50%;
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" aria-labelledby="profileDropdown">
                                    <li>
                                        <a href="#" class='dropdown-item' data-bs-toggle="modal"
                                            ...
                                            <i class="bi bi-pencil"></i> <span>Ubah Profile</span>
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="ubahProfileModalLabel">Ubah Profil</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @if (auth()->user()->role->name == 'user')
                                            <div class="mb-3">
                                                ...
                                                <input type="nis" class="form-control" name="nis"
                                        ...
                                        <div class="mb-3">
                                            <label for="img_profile" class="form-label">Ubah Gambar Profil</label>
                                            <input type="file" class="form-control" name="img_profile">
                                            @if ($user->img_profile)
                                                <img src="{{ asset('storage/' . $user->img_profile) }}"
