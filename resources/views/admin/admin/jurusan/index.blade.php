...
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createJurusanModal">Tambah
                        Jurusan</button>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($jurusan as $item)
                                        ...
                                        <td class="text-nowrap">
                                            <div class="dropdown dropup">
                                                ...
                                                <ul class="dropdown-menu"
                                                    ...
                                                    <!-- Delete Option -->
                                                    <li>
                                                        <form action="{{ route('jurusans.destroy', $item->id) }}"
                                                            method="POST"
                                    ...
                                    <div class="modal fade" id="editJurusanModal{{ $item->id }}" tabindex="-1"
                                        aria-labelledby="editJurusanModalLabel{{ $item->id }}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editJurusanModalLabel{{ $item->id }}">
                                                        Edit Jurusan</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <form action="{{ route('jurusans.update', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
    ...
    <div class="modal fade" id="createJurusanModal" tabindex="-1" aria-labelledby="createJurusanModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
